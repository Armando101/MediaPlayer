...
// Declaramos un Arreglo con los anuncios que mostraré
const ALL_ADS: Ad[] = [
    {
      imageUrl:
...
class Ads {
    // La instancia nos servirá para implementar el patrón de Singelton
    // Declaro un arreglo de Ads
    ...
    private initAds() {
        // Aquí no hacemos this.ads = ALL_ADS
        // Esto es porque en getAd haremos pop y no queremos que se eliminen los datos de la lista
        // Es por eso que creamos un arreglo nuevo con los mimos elementos
        this.ads = [...ALL_ADS];
    }

    getAd() {
        // Si se agotaron mis Ads los vuelvo a inicializar
